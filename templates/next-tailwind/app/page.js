...
export default function Home() {
  return (
    <div>
      <Image className="object-contain relative left-1/2 transform -translate-x-1/2" src="/create-launcher.webp" alt="Create Launcher" width={300} height={200} />

      <h1 className="text-[3rem] mb-[1rem]">Welcome Developer !!!</h1>
      <p className="text-[1rem] text-justify">
        This is a simple Next.js + Tailwind application.
      </p>
      <p className="text-[1rem] text-justify">
